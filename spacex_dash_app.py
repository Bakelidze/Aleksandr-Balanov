...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                    options=[
                                        ...
                                        {'label': 'Kennedy LC-39A', 'value': 'KSC LC-39A'},
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        title = f'Success and Failure Launches - {entered_site}'

        fig = px.pie(values=values, names=labels, title=title)
        fig.update_layout(title=f'Success and Failure Count for {entered_site}')
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(data_frame=filtered_df, x='Payload Mass (kg)', y='class',
                         color='Booster Version Category', title='Scatter Plot for All Sites')
    else:
        ...
        fig = px.scatter(data_frame=filtered_df, x='Payload Mass (kg)', y='class',
                         color='Booster Version Category', title=f'Scatter Plot for {entered_site}')
